	...
	<div class="wrapper">
		...
		<div class="breadcrumbs-v4">
			<div class="container">
				...
				<h1>
					UNIFY Nâng Niu <span class="shop-green">Đôi Chân</span> Của Bạn
				</h1>
						...
						<section>
							<div class="row">
								<div class="col-md-6 md-margin-bottom-50">
									<h2 class="title-type">Lựa chọn phương thức thanh toán</h2>
									<!-- Accordion -->
										...
										<div class="panel-group" id="accordion">
												...
												<div id="collapseOne" class="panel-collapse collapse in">
													<div class="panel-body cus-form-horizontal">
														<div class="form-group">
															<label class="col-sm-4 no-col-space control-label">Tên Thẻ</label>
															<div class="col-sm-8">
														...
														<div class="form-group">
															<label class="col-sm-4 no-col-space control-label">Số thẻ</label>
															<div class="col-sm-8">
																<input type="text" class="form-control required"
														...
														<div class="form-group">
															<label class="col-sm-4 no-col-space control-label">Loại Thanh Toán</label>
															<div class="col-sm-8">
														...
														<div class="form-group">
															<label class="col-sm-4">Ngày Hết Hạn</label>
														...
														<div class="form-group">
															...
															<div class="col-sm-8 input-small-field">
																<input type="text" name="number" placeholder=""
																	class="form-control required"> <a href="#">CSC là gì?</a>
															</div>
														</div>
													</div>
												</div>
											...
											<div class="panel panel-default">
												<div class="panel-heading">
													<h4 class="panel-title">
														<a data-toggle="collapse" data-parent="#accordion"
															href="#collapseTwo"> <i class="fa fa-paypal"></i> Thanh Toán Với PayPal
														</a>
													</h4>
												</div>
								...
								<div class="col-md-6">
									<h2 class="title-type">CÁC CÂU HỎI THƯỜNG GẶP</h2>
									<!-- Accordion -->
							...
							<div class="row">
								...
								<div class="col-sm-3 col-sm-offset-5">
									<ul class="list-inline total-result">
										<li>
											<h4>Tiền:</h4> <c:set var="total" value="${0}" /> <c:forEach
