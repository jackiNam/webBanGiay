					...
					<div class="panel-group" id="accordion-v2">
						<div class="panel panel-default">
							...
							<div id="collapseTwo" class="panel-collapse collapse in">
								<div class="panel-body">
									<ul class="list-unstyled checkbox-list">
										<a href="${pageContext.request.contextPath }/product/category?cate_id=1" >Nike</a>
										<br>
										<a href="${pageContext.request.contextPath }/product/category?cate_id=2" > Adidas</a>
										<br>
										<a href="${pageContext.request.contextPath }/product/category?cate_id=3" > Gucci</a>
										<br>
										<a href="${pageContext.request.contextPath }/product/category?cate_id=4" > Puma</a>
									</ul>
								</div>
							</div>
						</div>
