	...
	<div class="wrapper">
				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<ul class="list-inline product-ratings margin-bottom-30">
							...
							<li><i class="rating fa fa-star"></i></li>
							<li class="product-review-list"><span>(1) <a href="#">Xem trước</a>
									| <a href="#"> Thêm vào xem trước</a></span></li>
						</ul>
						...
						<div class="margin-bottom-40">
							...
							<form name="f1" class="product-quantity sm-margin-bottom-20"
								...
								<button type='button' class="quantity-button" name='add'
									...
									value='+'>+</button>
								<button type="submit" class="btn-u btn-u-sea-shop btn-u-lg">Thêm giỏ hàng</button>
							</form>
						...
						<ul class="list-inline add-to-wishlist add-to-wishlist-brd">
							<li class="wishlist-in"><i class="fa fa-heart"></i> <a
								href="#">Thêm vào ưu thíc</a></li>
							<li class="compare-in"><i class="fa fa-exchange"></i> <a
								href="#">So sánh</a></li>
						</ul>
						<p class="wishlist-category">
							<strong>Danh mục:</strong> <a href="#">${product.category.name },</a>
						</p>
					</div>
				</div>
				<!--/end row-->
			...
			<div class="row margin-bottom-60">
				<div class="col-md-4 product-service md-margin-bottom-30">
					...
					<div class="product-service-in">
						...
						<p>Miễn phí vận chuyển cho đơn hàng trên 3 sản phẩm</p>
						<a href="#">Đọc thêm</a>
					</div>
				</div>
				<div class="col-md-4 product-service md-margin-bottom-30">
				...
				<div class="col-md-4 product-service">
					...
					<div class="product-service-in">
						<h3>Miễn phí hoàn đơn</h3>
						<p>Miễn phí hoàn đơn nếu bạn không hài lòng trong vòng 7 ngày.</p>
						<a href="#">Đọc thêm</a>
					</div>
				</div>
			</div>
						...
						<div class="row">
							...
							<div class="col-md-5">
								<div class="responsive-video">
									<iframe width="560" height="315" src="https://www.youtube.com/embed/oH3tpbBdGaU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
								</div>
							</div>
						</div>
					</div>
		...
		<div class="container">
			<div class="heading heading-v1 margin-bottom-20">
				...
				<p>Bạn có thể tham khảo một số sản phẩm khác </p>
			</div>
			...
			<div class="illustration-v2 margin-bottom-60">
				...
				<ul class="list-inline owl-slider-v4">
					<li class="item"><a href="#"><img class="img-responsive"
							src="${url}/img/bitis1.jpg" alt=""></a>
						<div class="product-description-v2">
							<div class="margin-bottom-5">
								<h4 class="title-price">
									<a href="#">Biti's Hunter Core Classic Blue</a>
								</h4>
					...
					<li class="item"><a href="#"><img class="img-responsive"
							src="${url}/img/b2.jpg" alt=""></a>
						<div class="product-description-v2">
							<div class="margin-bottom-5">
								<h4 class="title-price">
									<a href="#">Double-breasted PRO 2D43</a>
								</h4>
					...
					<li class="item"><a href="#"><img class="img-responsive"
							src="${url}/img/b3.jpg" alt=""></a>
						<div class="product-description-v2">
							<div class="margin-bottom-5">
								<h4 class="title-price">
									<a href="#">Biti's Hunter Layered Upper</a>
								</h4>
								<span class="title-price">$95.00</span>
							</div>
							<ul class="list-inline product-ratings">
					...
					<li class="item"><a href="#"><img class="img-responsive"
							src="${url}/img/b4.jpg" alt=""></a>
						<div class="product-description-v2">
							<div class="margin-bottom-5">
								<h4 class="title-price">
									<a href="#">Hunter Layered Upper DSWH02800KEM </a>
								</h4>
								<span class="title-price">$95.00</span>
							</div>
							<ul class="list-inline product-ratings">
