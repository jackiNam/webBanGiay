				...
				<div class="col-md-9">
					<div class="row margin-bottom-5">
						<div class="col-sm-4 result-category">
							<h2>Giày</h2>
							<small class="shop-bg-red badge-results">2 Kết quả</small>
						</div>
						<div class="col-sm-8">
								...
								<li class="sort-list-btn">
									...
									<div class="btn-group">
										...
										<ul class="dropdown-menu" role="menu">
											...
											<li><a href="#">Top bán chạy tuần</a></li>
										...
										<div class="overflow-h margin-bottom-5">
											...
											<ul class="list-inline add-to-wishlist margin-bottom-20">
												<li class="wishlist-in"><i class="fa fa-heart"></i> <a
													href=""
													${pageContext.request.contextPath }/product/detail?id=${p.id}"">Thêm vào danh sách ưu thích</a></li>
												<li class="compare-in"><i class="fa fa-exchange"></i> <a
													href=""
													${pageContext.request.contextPath }/product/detail?id=${p.id}"">Thêm vào danh sách so sánh</a></li>
											</ul>
											<a
