...
<body class="header-fixed">
	<div class="wrapper">
		...
		<div class="breadcrumbs-v4">
			<div class="container">
				<span class="page-name">Lọc theo</span>
				<h1>
					Nâng Niu <span class="shop-green">Đôi chân</span> của bạn
				</h1>
				<ul class="breadcrumb-v4-in">
					<li><a href="index.html">Trang chủ</a></li>
					<li><a href="">Sản phẩm</a></li>
					<li class="active">Danh sách sản phẩm đã lọc</li>
				</ul>
			</div>
			<!--/end container-->
		</div>
						...
						<div class="panel panel-default">
							...
							<div id="collapseTwo" class="panel-collapse collapse in">
								<div class="panel-body">
									<ul class="list-unstyled checkbox-list">
										<li><label class="checkbox"> <input
												type="checkbox" name="checkbox" checked /> <i></i> Adidas
												<small><a href="#">(23)</a></small>
										</label></li>
										<li><label class="checkbox"> <input
												type="checkbox" name="checkbox" checked /> <i></i> Nike
												<small><a href="#">(4)</a></small>
										</label></li>
										<li><label class="checkbox"> <input
												type="checkbox" name="checkbox" /> <i></i> Gucci <small><a
													href="#">(11)</a></small>
										</label></li>
									</ul>
								</div>
						...
						<div class="panel panel-default">
							...
							<div id="collapseThree" class="panel-collapse collapse in">
								<div class="panel-body">
									<ul class="list-unstyled checkbox-list">
										<li><label class="checkbox"> <input
												type="checkbox" name="checkbox" /> <i></i> 38 <small><a
													href="#">(23)</a></small>
										</label></li>
										<li><label class="checkbox"> <input
												type="checkbox" name="checkbox" checked /> <i></i> 39 <small><a
													href="#">(4)</a></small>
										</label></li>
										<li><label class="checkbox"> <input
												type="checkbox" name="checkbox" /> <i></i> 40<small><a
													href="#">(11)</a></small>
										</label></li>
										<li><label class="checkbox"> <input
												type="checkbox" name="checkbox" /> <i></i> 41 <small><a
													href="#">(3)</a></small>
										</label></li>
									</ul>
								</div>
							...
							<div class="panel-heading">
								<h2 class="panel-title">
									<a data-toggle="collapse" data-parent="#accordion-v5"
										href="#collapseFive"> Màu <i class="fa fa-angle-down"></i>
									</a>
								</h2>
							</div>
							...
							<div class="col-md-4">
								<div class="product-img product-img-brd">
									<a href="${pageContext.request.contextPath }/product/detail?id=${p.id}"><img class="full-width img-responsive"
										src="${p.image}" alt=""></a> <a
										class="product-review" href="${pageContext.request.contextPath }/product/detail?id=${p.id}">Xem đánh giá</a> <a class="add-to-cart" href="#"><i
								...
								<div
									...
									<div class="overflow-h margin-bottom-5">
										<div class="pull-left">
											...
											<span class="gender text-uppercase">Nike</span> <span
