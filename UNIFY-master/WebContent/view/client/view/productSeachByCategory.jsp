									...
									<div class="overflow-h margin-bottom-5">
										...
										<ul class="list-inline add-to-wishlist margin-bottom-20">
											<li class="wishlist-in"><i class="fa fa-heart"></i> <a
												href=""${pageContext.request.contextPath }/product/detail?id=${p.id}"">Thêm danh sách ưu thích</a></li>
											<li class="compare-in"><i class="fa fa-exchange"></i> <a
												href=""${pageContext.request.contextPath }/product/detail?id=${p.id}"">So sánh</a></li>
										</ul>
										<a href="${pageContext.request.contextPath }/product/detail?id=${p.id}" ><button type="button" class="btn-u btn-u-sea-shop">Thêm giỏ hàng</button></a>
									</div>
