	...
	<div class="wrapper">
		...
		<div class="breadcrumbs-v4">
			<div class="container">
				...
				<h1>
					UNIFY nâng niu <span class="shop-green">bàn chân</span> của bạn
				</h1>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-7 md-margin-bottom-50">
						<h2 class="welcome-title">Chào mừng tới Unify</h2>
						...
						<div class="members-number">
							<h3>
								Join more than <span class="shop-green">13,000</span> Thành viên
							</h3>
					...
					<div class="col-md-5">
						<form id="sky-form4" class="log-reg-block sky-form"
							...
							<label class="checkbox margin-bottom-10"> <input
								type="checkbox" name="checkbox" /> <i></i> Đăng kí để nhận ưu đãi
							</label> <label class="checkbox margin-bottom-20"> <input
								type="checkbox" name="checkbox" /> <i></i>Tôi đã đồng ý với <a href="#">Điều khoản &amp; Chính sách</a>
							</label>
